  ...
  public ButtonGlass()
  {
    ...
    addMouseListener(new MouseAdapter()
    {
      ...
      public void mouseEntered(MouseEvent e)
      {
       ...
       ButtonGlass.this.setOver(true);
        if (!(ButtonGlass.this.animation.isRunning())) {
          ButtonGlass.this.setPercent(-20);
          ButtonGlass.this.animation.start();
        }
      }
      ...
      {
        super.mouseExited(e);
        ButtonGlass.this.setOver(false);
      }
      ...
      public void mousePressed(MouseEvent e)
      {
        ...
        ButtonGlass.this.setPress(true);
      }
      ...
      public void mouseReleased(MouseEvent e)
      {
        ...
        ButtonGlass.this.setPress(false);
      }
    });
  }
